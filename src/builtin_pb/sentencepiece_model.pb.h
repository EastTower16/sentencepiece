...
#ifndef PROTOBUF_INCLUDED_src_2fsentencepiece_5fmodel_2eproto
#define PROTOBUF_INCLUDED_src_2fsentencepiece_5fmodel_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_src_2fsentencepiece_5fmodel_2eproto 
...
class TrainerSpec : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:sentencepiece.TrainerSpec) */ {
 public:
  ...
  // optional string custom_vocab_for_nonenglish_path = 54;
  bool has_custom_vocab_for_nonenglish_path() const;
  void clear_custom_vocab_for_nonenglish_path();
  static const int kCustomVocabForNonenglishPathFieldNumber = 54;
  const ::std::string& custom_vocab_for_nonenglish_path() const;
  void set_custom_vocab_for_nonenglish_path(const ::std::string& value);
  #if LANG_CXX11
  void set_custom_vocab_for_nonenglish_path(::std::string&& value);
  #endif
  void set_custom_vocab_for_nonenglish_path(const char* value);
  void set_custom_vocab_for_nonenglish_path(const char* value, size_t size);
  ::std::string* mutable_custom_vocab_for_nonenglish_path();
  ::std::string* release_custom_vocab_for_nonenglish_path();
  void set_allocated_custom_vocab_for_nonenglish_path(::std::string* custom_vocab_for_nonenglish_path);
 ...
 private:
  ...
  void clear_has_enable_differential_privacy();
  void set_has_differential_privacy_noise_level();
  void clear_has_differential_privacy_noise_level();
  void set_has_differential_privacy_clipping_threshold();
  void clear_has_differential_privacy_clipping_threshold();
  ...
  void set_has_allow_whitespace_only_pieces();
  void clear_has_allow_whitespace_only_pieces();
  void set_has_split_digits();
  void clear_has_split_digits();
  void set_has_pretokenization_delimiter();
  void clear_has_pretokenization_delimiter();
  ...
  void set_has_custom_vocab_for_nonenglish_path();
  void clear_has_custom_vocab_for_nonenglish_path();
  ...
  ::google::protobuf::internal::ArenaStringPtr custom_vocab_for_nonenglish_path_;
...
inline const ::std::string& TrainerSpec::pretokenization_delimiter() const {
  ...
  return pretokenization_delimiter_.GetNoArena();
}
...
inline void TrainerSpec::set_pretokenization_delimiter(::std::string&& value) {
  set_has_pretokenization_delimiter();
  pretokenization_delimiter_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline ::std::string* TrainerSpec::release_pretokenization_delimiter() {
  ...
  clear_has_pretokenization_delimiter();
  return pretokenization_delimiter_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
// optional string custom_vocab_for_nonenglish_path = 54;
inline bool TrainerSpec::has_custom_vocab_for_nonenglish_path() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void TrainerSpec::set_has_custom_vocab_for_nonenglish_path() {
  _has_bits_[0] |= 0x00000200u;
}
inline void TrainerSpec::clear_has_custom_vocab_for_nonenglish_path() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void TrainerSpec::clear_custom_vocab_for_nonenglish_path() {
  custom_vocab_for_nonenglish_path_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  clear_has_custom_vocab_for_nonenglish_path();
}
inline const ::std::string& TrainerSpec::custom_vocab_for_nonenglish_path() const {
  // @@protoc_insertion_point(field_get:sentencepiece.TrainerSpec.custom_vocab_for_nonenglish_path)
  return custom_vocab_for_nonenglish_path_.GetNoArena();
}
inline void TrainerSpec::set_custom_vocab_for_nonenglish_path(const ::std::string& value) {
  set_has_custom_vocab_for_nonenglish_path();
  custom_vocab_for_nonenglish_path_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:sentencepiece.TrainerSpec.custom_vocab_for_nonenglish_path)
}
#if LANG_CXX11
inline void TrainerSpec::set_custom_vocab_for_nonenglish_path(::std::string&& value) {
  set_has_custom_vocab_for_nonenglish_path();
  custom_vocab_for_nonenglish_path_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:sentencepiece.TrainerSpec.custom_vocab_for_nonenglish_path)
}
#endif
inline void TrainerSpec::set_custom_vocab_for_nonenglish_path(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  set_has_custom_vocab_for_nonenglish_path();
  custom_vocab_for_nonenglish_path_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:sentencepiece.TrainerSpec.custom_vocab_for_nonenglish_path)
}
inline void TrainerSpec::set_custom_vocab_for_nonenglish_path(const char* value, size_t size) {
  set_has_custom_vocab_for_nonenglish_path();
  custom_vocab_for_nonenglish_path_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:sentencepiece.TrainerSpec.custom_vocab_for_nonenglish_path)
}
inline ::std::string* TrainerSpec::mutable_custom_vocab_for_nonenglish_path() {
  set_has_custom_vocab_for_nonenglish_path();
  // @@protoc_insertion_point(field_mutable:sentencepiece.TrainerSpec.custom_vocab_for_nonenglish_path)
  return custom_vocab_for_nonenglish_path_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* TrainerSpec::release_custom_vocab_for_nonenglish_path() {
  // @@protoc_insertion_point(field_release:sentencepiece.TrainerSpec.custom_vocab_for_nonenglish_path)
  if (!has_custom_vocab_for_nonenglish_path()) {
    return NULL;
  }
  clear_has_custom_vocab_for_nonenglish_path();
  return custom_vocab_for_nonenglish_path_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void TrainerSpec::set_allocated_custom_vocab_for_nonenglish_path(::std::string* custom_vocab_for_nonenglish_path) {
  if (custom_vocab_for_nonenglish_path != NULL) {
    set_has_custom_vocab_for_nonenglish_path();
  } else {
    clear_has_custom_vocab_for_nonenglish_path();
  }
  custom_vocab_for_nonenglish_path_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), custom_vocab_for_nonenglish_path);
  // @@protoc_insertion_point(field_set_allocated:sentencepiece.TrainerSpec.custom_vocab_for_nonenglish_path)
}
...
#endif  // PROTOBUF_INCLUDED_src_2fsentencepiece_5fmodel_2eproto
